...
namespace WCF.Entities
{
    ...
    public class ColOperacion
    {
        ...
        private int getLastNumber(string idEmpresa, string idTipo)
        {
            ...
            DataTable miTabla = myHandler.Consulta("cola_operaciones_LAST", parametros);
        ...
        public string NullOne(ColOperacion one, List<ColMovimiento> detail)
        {
            string procedureName = "";
            string response = "";
            bool res = false;
